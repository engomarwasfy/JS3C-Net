...
def UNet(dimension, reps, nPlanes, residual_blocks=False, downsample=[2, 2], leakiness=0, n_input_planes=-1, groups=1):
    """
        ...
        if residual_blocks: #ResNet style blocks
            m.add(scn.ConcatTable()
                  ...
                  .add(scn.Sequential()
                    ...
                    .add(scn.SubmanifoldConvolution(dimension, b, b, 3, False, groups=groups)))
             ).add(scn.AddTable())
